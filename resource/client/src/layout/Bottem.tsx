...
const Bottem = () => {
    return (
        <>
            ...
            <ul className='m-auto text-center align-middle  p-1 rounded-sm dark:bg-zinc-950 dark:text-white absolute bottom-0 w-full'>
                <Divider />
                <li className="hs-accordion flex justify-center w-fit  text-center align-middle items-center rounded-lg hover:bg-[#002A47] dark:hover:bg-[#313131]   hover:text-white px-3" id="users-accordion" >
