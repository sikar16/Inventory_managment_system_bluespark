  ...
  return (
    <>
      <div className='bg-[#002A47] w-full h-screen text-white  items-center justify-center'>
        ...
        <div className='w-full max-w-md p-6 shadow-md rounded-lg text-white text-center m-auto'>
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate>
            ...
            <div className='flex justify-center'>
              <button type="submit" className='bg-white text-[#002A47] px-3 py-[3px] rounded-md transition'>
                Submit
              </button>
            </div>
          </form>
